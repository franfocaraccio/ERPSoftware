...
- **Asistente de ayuda**: falta la `OPENAI_API_KEY` en Railway. El chat está
...
| `OPENAI_API_KEY` | Sin ella el asistente queda deshabilitado y la ruta contesta 503 |
| `ASISTENTE_MODELO` | Opcional. Default `gpt-5.4-mini` |
